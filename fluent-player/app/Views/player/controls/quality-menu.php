 ...
 * Shows quality selection for HLS streams (Bunny Stream, etc.)
 */
...
<media-menu>
    <media-tooltip>
        <media-tooltip-trigger>
            <media-menu-button class="fp-media-button" aria-label="<?php echo esc_attr__('Quality', 'fluent-player'); ?>">
                <media-icon type="settings"></media-icon>
            </media-menu-button>
        </media-tooltip-trigger>
        <media-tooltip-content class="fp-media-tooltip" placement="top">
            <span><?php esc_html_e('Quality', 'fluent-player'); ?></span>
