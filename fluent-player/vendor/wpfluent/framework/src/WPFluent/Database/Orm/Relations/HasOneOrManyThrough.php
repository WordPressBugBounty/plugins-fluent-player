...
use FluentPlayer\Framework\Database\Orm\SoftDeletes;
...
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentPlayer\Framework\Database\Orm\Model| \FluentPlayer\Framework\Database\Orm\Collection<int, TRelatedModel>
     *
     ...
     * @param  (\Closure(): TValue)|null  $callback
     * @return \FluentPlayer\Framework\Database\Orm\Model|\FluentPlayer\Framework\Database\Orm\Collection<int, TRelatedModel>|TValue
     */
