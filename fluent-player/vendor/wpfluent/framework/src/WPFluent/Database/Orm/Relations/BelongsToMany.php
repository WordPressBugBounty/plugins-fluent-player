...
use FluentPlayer\Framework\Database\Orm\ModelNotFoundException;
use FluentPlayer\Framework\Database\Query\Grammars\MySqlGrammar;
use FluentPlayer\Framework\Database\Orm\Relations\Concerns\AsPivot;
...
use FluentPlayer\Framework\Database\Orm\Relations\Concerns\InteractsWithPivotTable;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\FluentPlayer\Framework\Database\Query\Expression>
     */
     ...
     *
     *
     * @param  \FluentPlayer\Framework\Database\Orm\Builder<TRelatedModel>  $query
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Orm\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Orm\Collection<int, TRelatedModel>  $results
     ...
     *
     * @param  string|\FluentPlayer\Framework\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentPlayer\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentPlayer\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|null
     */
     ...
     * @param  array  $columns
     * @return \FluentPlayer\Framework\Database\Orm\Collection<int, TRelatedModel>
     */
     ...
     * @return \FluentPlayer\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     *
     * @throws \FluentPlayer\Framework\Database\Orm\ModelNotFoundException<TRelatedModel>
     */
     ...
     * @return \FluentPlayer\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|TValue
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentPlayer\Framework\Pagination\Paginator
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \FluentPlayer\Framework\Support\LazyCollection<int, TRelatedModel>
     */
     ...
     *
     * @return \FluentPlayer\Framework\Database\Orm\Builder<TRelatedModel>
     */
     ...
     *
     * @return \FluentPlayer\Framework\Support\Collection<int, int|string>
     */
     ...
     *
     * @template TContainer of \FluentPlayer\Framework\Support\Collection<array-key, TRelatedModel>|array<array-key, TRelatedModel>
     *
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Orm\Builder<TRelatedModel>  $query
     * @param  \FluentPlayer\Framework\Database\Orm\Builder<TDeclaringModel>  $parentQuery
     ...
     *
     * @param  string|\FluentPlayer\Framework\Database\Query\Expression  $column
     * @return string|\FluentPlayer\Framework\Database\Query\Expression
     */
