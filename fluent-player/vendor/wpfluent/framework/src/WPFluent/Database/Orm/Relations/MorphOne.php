...
use FluentPlayer\Framework\Database\Orm\SupportsPartialRelations;
use FluentPlayer\Framework\Database\Orm\Relations\Concerns\CanBeOneOfMany;
...
class MorphOne extends MorphOneOrMany implements SupportsPartialRelations
{
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Query\JoinClause  $join
     * @return void
     */
