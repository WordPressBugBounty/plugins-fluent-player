...
use FluentPlayer\Framework\Support\HelperFunctionsTrait;
use FluentPlayer\Framework\Database\Query\Expression;
use FluentPlayer\Framework\Database\Concerns\BuildsQueries;
use FluentPlayer\Framework\Database\RecordsNotFoundException;
use FluentPlayer\Framework\Database\Orm\Relations\Relation;
use FluentPlayer\Framework\Database\Orm\Relations\BelongsToMany;
use FluentPlayer\Framework\Database\Orm\RelationNotFoundException;
use FluentPlayer\Framework\Database\Orm\Concerns\QueriesRelationships;
use FluentPlayer\Framework\Database\UniqueConstraintViolationException;
use FluentPlayer\Framework\Database\Query\Builder as QueryBuilder;

/**
 * @property-read HigherOrderBuilderProxy $orWhere
 *
 * @mixin \FluentPlayer\Framework\Database\Query\Builder
 *
 * @template TModel of \FluentPlayer\Framework\Database\Orm\Model
 */
class Builder
{
     ...
     *
     * @var \FluentPlayer\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \FluentPlayer\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @return \FluentPlayer\Framework\Database\Orm\Model|static
     */
     ...
     * @param  \FluentPlayer\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Orm\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \FluentPlayer\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\FluentPlayer\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\FluentPlayer\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\FluentPlayer\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \FluentPlayer\Framework\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentPlayer\Framework\Database\Orm\Model|\FluentPlayer\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Support\ArrayableInterface|array  $ids
     * @param  array  $columns
     * @return \FluentPlayer\Framework\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentPlayer\Framework\Database\Orm\Model|\FluentPlayer\Framework\Database\Orm\Collection|static|static[]
     *
     * @throws \FluentPlayer\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     * @return TModel|TValue|\FluentPlayer\Framework\Database\Orm\Collection
     */
     ...
     * @return \FluentPlayer\Framework\Database\Orm\Model|static|mixed
     */
     ...
     * @return mixed
     *
     * @throws \FluentPlayer\Framework\Database\Orm\ModelNotFoundException<TModel>
     * @throws \FluentPlayer\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  array|string  $columns
     * @return \FluentPlayer\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \FluentPlayer\Framework\Database\Orm\Relations\Relation
     */
     ...
     * @return \FluentPlayer\Framework\Pagination\LengthAwarePaginator
     *
     ...
     * @return \FluentPlayer\Framework\Pagination\CursorPaginator
     */
     ...
     *
     * @param  array  $attributes
     * @return \FluentPlayer\Framework\Database\Orm\Model|$this
     */
     ...
     *
     * @param  array|\FluentPlayer\Framework\Database\Query\Expression  $columns
     * @return array
     */
