...
use FluentPlayer\Framework\Container\Container;
...
use FluentPlayer\Framework\Support\Conditionable;
...
use FluentPlayer\Framework\Database\MultipleRecordsFoundException;
use FluentPlayer\Framework\Pagination\Cursor;
use FluentPlayer\Framework\Pagination\Paginator;
use FluentPlayer\Framework\Pagination\CursorPaginator;
use FluentPlayer\Framework\Pagination\LengthAwarePaginator;
...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\FluentPlayer\Framework\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \FluentPlayer\Framework\Support\Collection<int, TReturn>
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Query\Builder|\FluentPlayer\Framework\Database\Orm\Builder<*>  $builder
     ...
     * @param  \FluentPlayer\Framework\Support\Collection  $items
     * @param  int  $perPage
     * @param  \FluentPlayer\Framework\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \FluentPlayer\Framework\Pagination\CursorPaginator
     */
