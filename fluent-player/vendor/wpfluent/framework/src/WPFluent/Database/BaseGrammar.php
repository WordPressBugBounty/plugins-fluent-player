...
namespace FluentPlayer\Framework\Database;
...
abstract class BaseGrammar
{
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Query\Expression|string  $table
     * @return string
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Query\Expression|string|int|float  $expression
