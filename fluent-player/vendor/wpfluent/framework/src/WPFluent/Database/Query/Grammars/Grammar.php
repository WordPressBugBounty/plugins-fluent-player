...
namespace FluentPlayer\Framework\Database\Query\Grammars;

use RuntimeException;
use FluentPlayer\Framework\Support\Arr;
use FluentPlayer\Framework\Support\Helper;
use FluentPlayer\Framework\Database\BaseGrammar;
use FluentPlayer\Framework\Database\Query\Builder;
use FluentPlayer\Framework\Database\Query\Expression;
use FluentPlayer\Framework\Database\Query\JoinClause;
use FluentPlayer\Framework\Database\Query\JoinLateralClause;
use FluentPlayer\Framework\Database\Concerns\CompilesJsonPaths;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Query\JoinLateralClause  $join
