...
use FluentPlayer\Framework\Foundation\App;
use FluentPlayer\Framework\Support\Arr;
use FluentPlayer\Framework\Support\Str;
use FluentPlayer\Framework\Support\Helper;
use FluentPlayer\Framework\Support\MacroableTrait;
use FluentPlayer\Framework\Support\Collection;
use FluentPlayer\Framework\Pagination\Paginator;
use FluentPlayer\Framework\Support\ForwardsCalls;
use FluentPlayer\Framework\Support\LazyCollection;
use FluentPlayer\Framework\Database\Query\Expression;
use FluentPlayer\Framework\Database\Query\Grammars\Grammar;
use FluentPlayer\Framework\Database\Query\Processors\Processor;
use FluentPlayer\Framework\Database\Query\ConditionExpression;
use FluentPlayer\Framework\Support\ArrayableInterface;
use FluentPlayer\Framework\Database\ConnectionInterface;
use FluentPlayer\Framework\Database\Concerns\BuildsQueries;
use FluentPlayer\Framework\Database\Concerns\BuildsWhereDateClauses;
use FluentPlayer\Framework\Database\Concerns\ExplainsQueries;
use FluentPlayer\Framework\Database\Orm\Relations\Relation;
use FluentPlayer\Framework\Database\Orm\Builder as OrmBuilder;
...
class Builder
{
     ...
     *
     * @var \FluentPlayer\Framework\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \FluentPlayer\Framework\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \FluentPlayer\Framework\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \FluentPlayer\Framework\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     *
     * @param  \FluentPlayer\Framework\Database\ConnectionInterface  $connection
     * @param  \FluentPlayer\Framework\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \FluentPlayer\Framework\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\FluentPlayer\Framework\Database\Query\Builder|\FluentPlayer\Framework\Database\Orm\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\FluentPlayer\Framework\Database\Query\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Closure|\FluentPlayer\Framework\Database\Query\Builder|string  $table
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \FluentPlayer\Framework\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  string  $table
     * @return \FluentPlayer\Framework\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\FluentPlayer\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Query\Expression|string  $column
     * @param  string  $value
     ...
     *
     * @param  string  $column
     * @param  \FluentPlayer\Framework\Support\ArrayableInterface|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|\FluentPlayer\Framework\Database\Query\Expression  $column
     * @param  array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     ...
     *
     * @return \FluentPlayer\Framework\Database\Query\Builder
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Query\Expression[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  \Closure|\FluentPlayer\Framework\Database\Orm\Builder|\FluentPlayer\Framework\Database\Query\Builder|\FluentPlayer\Framework\Database\Query\Expression|string  $column
     * @param  string $direction
     ...
     *
     * @param  \Closure|\FluentPlayer\Framework\Database\Query\Builder|\FluentPlayer\Framework\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \FluentPlayer\Framework\Database\RecordsNotFoundException
     * @throws \FluentPlayer\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Support\Collection  $items
     * @return \FluentPlayer\Framework\Support\Collection
     */
     ...
     * @return \FluentPlayer\Framework\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentPlayer\Framework\Pagination\PaginatorInterface
     */
     ...
     * @param  \FluentPlayer\Framework\Pagination\Cursor|string|null  $cursor
     * @return \FluentPlayer\Framework\Pagination\CursorPaginatorInterface
     */
     ...
     *
     * @return \FluentPlayer\Framework\Support\LazyCollection
     */
     ...
     *
     * @param  mixed  $value
     * @return \FluentPlayer\Framework\Database\Query\Expression
     */
     ...
     *
     * @return \FluentPlayer\Framework\Database\ConnectionInterface
     */
     ...
     *
     * @return \FluentPlayer\Framework\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \FluentPlayer\Framework\Database\Query\Grammars\Grammar
     */
