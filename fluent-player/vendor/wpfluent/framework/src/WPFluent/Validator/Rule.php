...
namespace FluentPlayer\Framework\Validator;
...
use FluentPlayer\Framework\Validator\Rules\In;
use FluentPlayer\Framework\Validator\Rules\NotIn;
use FluentPlayer\Framework\Validator\Rules\Unique;
use FluentPlayer\Framework\Validator\Rules\Exists;
use FluentPlayer\Framework\Validator\Rules\RequiredIf;
use FluentPlayer\Framework\Validator\Rules\Dimensions;
use FluentPlayer\Framework\Validator\Rules\ConditionalRules;
...
class Rule
{
     ...
     * @return \FluentPlayer\Framework\Validator\Rules\ConditionalRules
     */
     ...
     * @return \FluentPlayer\Framework\Validator\Rules\Dimensions
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentPlayer\Framework\Validator\Rules\Exists
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Support\ArrayableInterface|array|string  $values
     * @return \FluentPlayer\Framework\Validator\Rules\In
     */
     ...
     *
     * @param  \FluentPlayer\Framework\Support\ArrayableInterface|array|string  $values
     * @return \FluentPlayer\Framework\Validator\Rules\NotIn
     */
     ...
     * @return \FluentPlayer\Framework\Validator\Rules\RequiredIf
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentPlayer\Framework\Validator\Rules\Unique
     */
