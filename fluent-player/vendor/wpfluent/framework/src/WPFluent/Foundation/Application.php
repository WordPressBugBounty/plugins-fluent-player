...
use FluentPlayer\Framework\Support\Env;
use FluentPlayer\Framework\Http\Client;
use FluentPlayer\Framework\Foundation\Config;
use FluentPlayer\Framework\Container\Container;
use FluentPlayer\Framework\Foundation\ComponentBinder;
use FluentPlayer\Framework\Foundation\Concerns\FoundationTrait;
 ...
 *
 * @property \FluentPlayer\Framework\Foundation\Config        $config
 * @property \FluentPlayer\Framework\View\View                $view
 * @property \FluentPlayer\Framework\Cache\Cache              $cache
 * @property \FluentPlayer\Framework\Http\Router\Router       $router
 * @property \FluentPlayer\Framework\Http\Request\Request     $request
 * @property \FluentPlayer\Framework\Http\Response\Response   $response
 * @property \FluentPlayer\Framework\Validator\Validator      $validator
 * @property \FluentPlayer\Framework\Events\Dispatcher        $events
 * @property \FluentPlayer\Framework\Encryption\Encrypter     $encrypter
 * @property \FluentPlayer\Framework\Encryption\Encrypter     $crypt
 * @property \FluentPlayer\Framework\Database\DatabaseManager $db
 * @property \FluentPlayer\Framework\Http\URL                 $url
 * @property \FluentPlayer\Framework\Support\Mail             $mail
 * @property \FluentPlayer\Framework\Support\Pipeline         $pipeline
...
class Application extends Container
{
     ...
     * 
     * @param \FluentPlayer\Framework\Http\Router $router
     * 
     * @return void
     */
