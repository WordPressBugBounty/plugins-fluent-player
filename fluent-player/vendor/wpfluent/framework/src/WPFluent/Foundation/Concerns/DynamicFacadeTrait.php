...
namespace FluentPlayer\Framework\Foundation\Concerns;

use FluentPlayer\Framework\Support\Facade;
...
trait DynamicFacadeTrait
{
     ...
     *
     * @param  string $facade Facade namespace prefix (e.g., FluentPlayer\Framework\Facade)
