...
namespace FluentPlayer\Framework\Support;
...
class Stringable implements JsonSerializable
{
     ...
     *
     * @param  \FluentPlayer\Framework\Support\Stringable|string  $value
     * @return bool
     */
     ...
     * @param  string  $delimiter
     * @param  int  $limit
     * @return \FluentPlayer\Framework\Support\Collection<int, string>
     */
